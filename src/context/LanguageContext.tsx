...
const translations = {
  ...
  ar: {
    ...
    'home.whyChooseUs.subtitle': 'نحن ملتزمون بتقديم وصلات الشعر عالية الجودة مع خدمة استثنائية. إليك ما يميزنا عن الآخرين.',
    ...
    'home.whyChooseUs.ethicallySourced.description': 'نحن نشارك مع موردين أخلاقيين لضمان أن وصلات الشعر لدينا مصدرها مسؤول وعادل.',
    ...
    'home.whyChooseUs.fastShipping.description': 'استمتعي بالشحن المجاني على الطلبات أكثر من 150$ مع تغليف آمن وتتبع مضمن.',
    'home.whyChooseUs.colorPerfection.title': 'كمال اللون',
    'home.whyChooseUs.colorPerfection.description': 'تقنيتنا المتقدمة لمطابقة الألوان تضمن أن وصلاتك تمتزج بسلاسة مع شعرك الطبيعي.',
    'home.whyChooseUs.expertSupport.title': 'دعم خبير',
    'home.whyChooseUs.expertSupport.description': 'مستشارو الجمال لدينا يقدمون نصائح شخصية لمساعدتك في اختيار الوصلات المثالية لأسلوبك.',
    'home.whyChooseUs.cta.title': 'مستعدة لتحويل إطلالتك؟',
    'home.whyChooseUs.cta.description': 'انضمي إلى آلاف العملاء السعداء الذين اكتشفوا الفرق مع سلطانة هير.',
